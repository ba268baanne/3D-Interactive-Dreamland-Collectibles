...
import { Search, Palette, ShoppingBag, Package } from "lucide-react";

const steps = [
  {
    icon: Search,
    title: "Choose",
    description: "Browse our curated collection and find the perfect piece",
    color: "#a8d8ff",
    delay: 0
  },
  {
    icon: Palette,
    title: "Customize",
    description: "Select variations and personalize your collectible",
    color: "#c9b3ff",
    delay: 200
  },
  {
    icon: ShoppingBag,
    title: "Order",
    description: "Secure checkout with worldwide shipping",
    color: "#ffb366",
    delay: 400
  },
  {
    icon: Package,
    title: "Display",
    description: "Receive and showcase your new treasure",
    color: "#a8d8ff",
    delay: 600
  }
];
