    ...
    <div className="relative h-screen w-full overflow-hidden">
      ...
      >
        ...
        <div className="mb-8 inline-flex items-center gap-2 glass-morphism px-6 py-3 rounded-full animate-in fade-in slide-in-from-top duration-700">
          ...
          <span className="text-sm text-gray-300 tracking-[0.2em] uppercase font-medium">Premium Collectibles</span>
        </div>
        ...
        >
          <span className="relative z-10 tracking-wide">Enter the Collection</span>
